...
class MockRepository extends Mock implements MyPostsRepository{}
void main() {
  List<Post> tposts = [Post(id: '1',description: "test description", title: 'test post 1', date: '23-05-2024', proposalCount: 5, hiredCount: 0, duration: 'less than one month', amount: 300, subjects: ["math","physics"], postedBy: 'hafid test', postedById: '1')];
